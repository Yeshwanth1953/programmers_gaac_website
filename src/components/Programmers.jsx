...
export default function Programmers() {
  return (
    <TeamLayout
      ...
      activities={[
        { title: "🛰 Flight Software", desc: "Embedded and high-level aerospace systems." },
        { title: "📊 Data & Simulation", desc: "Mission analytics and simulation tools." },
        { title: "🤖 AI & Automation", desc: "Machine learning for aerospace applications." },
      ]}
    />
  );
}
