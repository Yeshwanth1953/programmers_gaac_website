...
export default function Stargazers() {
  return (
    <TeamLayout
      ...
      activities={[
        { title: "🌌 Stargazing Nights", desc: "Monthly telescope observation sessions." },
        { title: "📚 Lectures & Workshops", desc: "Expert-led astronomy sessions." },
        { title: "🔬 Research Projects", desc: "Hands-on space data and orbital research." },
      ]}
    />
  );
}
