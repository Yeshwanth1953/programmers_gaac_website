...
export default function Robusta() {
  return (
    <TeamLayout
      ...
      activities={[
        { title: "🚗 Autonomous Rovers", desc: "Designing intelligent navigation systems." },
        { title: "🚁 Aerial Drones", desc: "Building UAVs for mapping and research." },
        { title: "🧠 Control Systems", desc: "Embedded and AI-based robotics systems." },
      ]}
    />
  );
}
